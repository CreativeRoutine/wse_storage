...
//     let modelsAndTypes = [
//       // { model: Printer, searchField: "barcode sn ponumber name", type: 'printer' },
//       { model: Printer, searchFields: ["barcode", "sn", "ponumber", "name"], type: 'printer' },
//       { model: Supplier, searchField: 'ponumber name ', type: 'supplier' },
