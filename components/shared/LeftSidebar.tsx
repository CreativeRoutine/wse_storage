...
const LeftSidebar = () => {
  ...
  return (
    <section
      id="sidebar"
      className="bg-dark-200 custom-scrollbar fixed left-0 top-0 flex h-screen flex-col justify-start overflow-y-auto border-r border-dark-300 pt-12 shadow-light-300 dark:shadow-none max-sm:hidden sm:w-28  xl:w-96 print:hidden"
    >
      {/* Logo */}
      <Link
        className="logo flex flex-col justify-start items-center pl-10 pr-10"
        href="/"
      >
