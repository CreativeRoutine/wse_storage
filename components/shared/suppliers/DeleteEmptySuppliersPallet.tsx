...
import { deleteEmptySuppliersPallet } from '@/lib/actions/supplier.action';
...
export default  function DeleteEmptySuppliersPallet ({id}:Props){
  ...
  async function onSubmit() {
    ...
    try {
      ...
      const response = await deleteEmptySuppliersPallet({
      ...
      // defined as a hook
      router.push(`/supplier/${response.supplierID}`)
