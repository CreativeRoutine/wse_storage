...
import { getPartsByName, getPartsByProductNumber } from "@/lib/actions/parts.action"
          ...
          <Subheading className="!text-white !text-lg">Printer parts settings</Subheading>
            ...
            <DescriptionList className="mt-4" >
              ...
              <DescriptionDetails className="!text-white">
                ...
                {printerName ? printerName : <div className="text-red-500 ">Name not set</div>}
              </DescriptionDetails>
                ...
                <ul>
                  {
                    ...
                    <li key={partName.partsName} className="flex w-full justify-between items-center border-b border-gray-700 py-2">
                      {partName.partsName}
                      <MaxPartsInput initialLimit={partName.maxParts} printerPN={parts.printerName} label={partName.partsName} />
                    </li> : 
                    null)) :
                     "No parts added"
                  }
